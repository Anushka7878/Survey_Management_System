...
<div id="mySidenav" class="sidenav">
 ...
 <div class="menuu" id="dash"><a href="admin_homepage.php">Dashboard</a></div>
 
 <button class="dropdown-btn">User
    <i class="fa fa-caret-down"></i>
  </button>
  <div class="dropdown-container">
    <div class="sub-menuu"><a href="add_user.php">Add user </a></div>
    <div class="sub-menuu"><a href="user_list.php">User List</a></div>
    <!-- <div class="sub-menuu"><a href="display.php">Results of Survey</a></div> -->
  </div>
  ...
  <div class="dropdown-container">
    <div class="sub-menuu"><a href="entire.php">Create Survey </a></div>
