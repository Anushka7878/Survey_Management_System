...
.uneditable-input:focus {     
    ...
    box-shadow: 0 0px 0px rgba(0, 0, 0, 0.075) inset, 0 0 8px rgb(99, 195, 219);
    outline: none;
    border-radius: 4px;
}
...
//-----------------------------------------------------------------------------------
?>
<label class="echo" > <b>Enter Survey title: </b>
...
<div class="txtbx-1">
<label class="echo2" > <b >Description: </b>
...
while ($arrques = mysqli_fetch_array($showques)) {
    ...
    ?> <b> Question : <?php echo $arrques['question']; ?></b>



<!-- <?php echo $arrques['question_id']; ?> --><br>  
Answer : <input type="text" name="ans[]" style="width: 90vh; margin:10px;" id="<?php echo $arrques['question_id']; ?>" required>
<input  hidden type="text" name="qi[]" value="<?php echo $arrques['question_id']; ?>" required >
<br><br>
...
<center>
    ...
    <input class="btn btn-success" type="submit" value="Submit " id="save" name="save">
